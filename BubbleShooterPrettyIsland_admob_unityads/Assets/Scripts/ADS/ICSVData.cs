...
public class ICSVData<T> : SingletonBase<T> where T : new ()
{
    ...
    public bool GetPropertyToBool (string name, string id)
    {
        string str = GetProperty (name, id).ToString ();
        ...
        bool fData = bool.Parse (str);
        return fData;
    }
    public bool GetPropertyToBool (string name, int id)
    {
        return this.GetPropertyToBool (name, id.ToString ());
    }
}