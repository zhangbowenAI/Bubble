...
public class WUtil
{
    ...
    static StringBuilder sec2Hour = new StringBuilder();
    public static string hourStr, minStr;
    public static string Seconds2Hour(int sec)
    {
        TimeSpan ts = new TimeSpan(0, 0, sec);
        strBuilder.Length = 0;

        strBuilder.Append(ts.Hours).Append(hourStr).Append(ts.Minutes).Append(minStr);
    ...
    public static string GetUniqueIdentifier()
    {
        ...
        string md5Str = WUtil.Md5Func(str);
        return md5Str;
    }
